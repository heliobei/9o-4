  ...
  return (
    <div className="flex h-[80vh] gap-4 max-w-7xl mx-auto px-4 pt-4 overflow:hidden">
      ...
      <div className="relative h-3/4 bg-blue-200 rounded-xl flex flex-col justify-center items-center min-h-[450px]">
        ...
        Olá, professores! Sejam bem-vindos ao quarto site da camada digital da coleção <strong>Aprendendo a Lidar com Dinheiro – Educação Financeira</strong>. Veja abaixo sobre o que trataremos neste site.
        </p>
      </div>
